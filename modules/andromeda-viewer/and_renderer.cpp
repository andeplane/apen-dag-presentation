#include "and_renderer.h"
#include "and_controller.h"
...
void Renderer::checkIfFileExists(QString filename) {
    QFileInfo file(filename);
    if(!file.exists()) qDebug() << "File " << filename << " does not exist. This will crash soon.";
}
    ...
    m_renderAndromeda3x(true)
{
    ...
    QString imagePath = executablePath.append("/../apen-dag-presentation/");
    ...
    checkIfFileExists(path1x);
    checkIfFileExists(path2x);
    checkIfFileExists(path3x);
